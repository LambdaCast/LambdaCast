...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaItem.assemblyid'
        db.delete_column('portal_mediaitem', 'assemblyid')


    def backwards(self, orm):
        # Adding field 'MediaItem.assemblyid'
        db.add_column('portal_mediaitem', 'assemblyid',
