...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.license'
        db.add_column('portal_video', 'license',
                      self.gf('django.db.models.fields.CharField')(default='CC-BY', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.license'
        db.delete_column('portal_video', 'license')
