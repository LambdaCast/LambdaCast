...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.channelThumbURL'
        db.add_column('portal_channel', 'channelThumbURL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.channelThumbURL'
        db.delete_column('portal_channel', 'channelThumbURL')
