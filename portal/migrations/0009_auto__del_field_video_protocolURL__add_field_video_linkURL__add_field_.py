...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('portal_video', 'protocolURL')

        # Adding field 'Video.linkURL'
        db.add_column('portal_video', 'linkURL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Channel.description'
        db.add_column('portal_channel', 'description',
    ...
    def backwards(self, orm):
        ...
        db.add_column('portal_video', 'protocolURL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Video.linkURL'
        db.delete_column('portal_video', 'linkURL')

        # Deleting field 'Channel.description'
        db.delete_column('portal_channel', 'description')
