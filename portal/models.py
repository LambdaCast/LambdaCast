...
class MediaFile(models.Model):
    ...
    url = models.URLField(_(u"URL to Transcoded File"), null=False, max_length=512, help_text=_(u"Insert the link to the media file"))
...
class MediaItem(models.Model):
    ...
    linkURL = models.URLField(_(u"Link"),blank=True,null=False, help_text=_(u"Insert a link to a blog or website that relates to the media"))
    torrentURL = models.URLField(_(u"Torrent-URL"),blank=True,null=False,help_text=_(u"The URL to the torrent-file"))
    videoThumbURL = models.URLField(_(u"Video Thumb-URL"),blank=True,null=False, help_text=_(u"Use a picture as thumbnail for the media list"))
    audioThumbURL = models.URLField(_(u"Audio Cover-URL"),blank=True,null=False, help_text=_(u"Use a picture as cover for the media list"))
...
class Submittal(models.Model):
    ...
    media_linkURL = models.URLField(_(u"Link"),blank=True,null=False, help_text=_(u"Insert a link to a blog or website that relates to the media"))
    media_torrentURL = models.URLField(_(u"Torrent-URL"),blank=True,null=False,help_text=_(u"The URL to the torrent-file"))
    media_mp4URL = models.URLField(_(u"MP4-URL"),blank=True,null=False,help_text=_(u"Add the link of the media folder or any other one with .mp4 ending"))
    media_webmURL = models.URLField(_(u"WEBM-URL"),blank=True,null=False, help_text=_(u"Add the link of the media folder or any other one with .webm ending"))
    media_mp3URL = models.URLField(_(u"MP3-URL"),blank=True,null=False, help_text=_(u"Add the link of the media folder or any other one with .mp3 ending"))
    media_oggURL = models.URLField(_(u"OGG-URL"),blank=True,null=False, help_text=_(u"Add the link of the media folder or any other one with .ogg ending"))
