...
class MediaFile(models.Model):
    ...
    url = models.URLField(_(u"URL to Transcoded File"),  max_length=512, help_text=_(u"Insert the link to the media file"))
...
class Submittal(models.Model):
    ...
    media_oggURL = models.URLField(_(u"OGG-URL"),blank=True, help_text=_(u"Add the link of the media folder or any other one with .ogg ending"))
    media_opusURL = models.URLField(_(u"OPUS-URL"),blank=True, help_text=_(u"Add the link of the media folder or any other one with .opus ending"))
