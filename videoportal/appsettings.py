...
TRANSLOAD_NOTIFY_URL = 'http://rec.theradio.cc/encodingdone/'
...
ENCODING_OUTPUT_DIR = '/data/srv/OwnTube/media/encoded/'
# How can we reach this files (public access is needed)
ENCODING_VIDEO_BASE_URL = 'http://rec.theradio.cc/media/encoded/'
...
BITTORRENT_FILES_DIR = '/data/srv/OwnTube/owntube/media/torrents/'
...
BITTORRENT_FILES_BASE_URL = 'http://rec.theradio.cc/media/torrents/'
...
HOTFOLDER_BASE_DIR = '/data/srv/OwnTube/owntube/videostore/robotron/'
HOTFOLDER_MOVE_TO_DIR = '/data/srv/OwnTube/owntube/media/raw/'
