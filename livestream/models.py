...
class Stream(models.Model):
    ...
    link = models.URLField(_(u"Link"),blank=True,verify_exists=False)
    rtmpLink = models.URLField(_(u"RTMP Link"),blank=True,verify_exists=False,help_text=_(u"RTMP is a protocol to stream video. If you have a server as host, you can insert a link of the output"))
    audioOnlyLink = models.URLField(_(u"Audio-only Link"),blank=True,verify_exists=False)
