...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('portalapp_video', 'originalFile', self.gf('django.db.models.fields.files.FileField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'Video.originalFile'
        db.alter_column('portalapp_video', 'originalFile', self.gf('django.db.models.fields.files.FileField')(max_length=100))
